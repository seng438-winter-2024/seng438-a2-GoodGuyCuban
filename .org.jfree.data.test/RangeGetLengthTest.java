...
public class RangeGetLengthTest {
	    ...
	    public static Collection<Object[]> data() {
	        return Arrays.asList(new Object[][] {
	            ...
	            {1, 10, 9}, // Positive range
	            {5, 5, 0}, // Zero-length range
	            {-1, 1, 2}, // Range spanning from negative to positive
	            {5, 5.00001, 0.00001}, // Minimal positive range
	            {-1000000, 1000000, 2000000} // Large range
	        });
	    }
